...
module.exports = async function (deployer, network, accounts) {
    ...
    let uniswapfactoryInstance, uniswapRouterInstance, hardCoreInstance, uniswapOracle, uniswapPair
    if (network === 'development') {
        ...
        await hardCoreInstance.initialSetup(feeApproverInstance.address, feeDistributorInstance.address);
        await pausePromise('hardcore initial setup')

        await uniswapfactoryInstance.createPair(hardCoreInstance.address, wethInstance.address)
        uniswapPair = await uniswapfactoryInstance.getPair(hardCoreInstance.address, wethInstance.address)
    ...
    const routerAddress = uniswapRouterInstance.address
