...
contract('liquid vault', accounts => {
    ...
    setup(async () => {
        ...
        await hardcoreInstance.initialSetup(uniswapRouter.address, uniswapFactory.address, feeApproverInstance.address, distributorInstance.address, liquidVaultInstance.address)
